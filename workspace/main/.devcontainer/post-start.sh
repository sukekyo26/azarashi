...
# npm package ships build/, giving the statusline real savings numbers. Always
# reinstall to pick up the latest release; non-fatal so the statusline degrades
# gracefully when this CLI is absent.
